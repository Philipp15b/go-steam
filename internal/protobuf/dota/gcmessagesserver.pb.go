...
// discarding unused import matchmaker_common "matchmaker_common.pb"
...
func (m *CMsgLeaverDetected) GetObsoleteMassDisconnect() bool {
	if m != nil && m.ObsoleteMassDisconnect != nil {
		return *m.ObsoleteMassDisconnect
	}
	return false
}
...
type CMsgDOTALiveScoreboardUpdate_Team_Player struct {
	...
	UltimateState    *CMsgDOTALiveScoreboardUpdate_Team_Player_DOTAUltimateState `protobuf:"varint,14,opt,name=ultimate_state,enum=CMsgDOTALiveScoreboardUpdate_Team_Player_DOTAUltimateState,def=0" json:"ultimate_state,omitempty"`
